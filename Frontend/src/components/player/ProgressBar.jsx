...
const ProgressBar = ({ currentTime = 0, duration = 0, bufferedPercent = 0, onSeek }) => {
    ...
    >
      ...
      <div className="relative h-1.5 w-full rounded-full bg-white/20 backdrop-blur-xs transition-all duration-150 group-hover:h-2">
        ...
        <div
          ...
          className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-white shadow-md transform scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-150"
        >
      ...
      {hoverPosition !== null && duration > 0 && (
        <div
          ...
          className="absolute -top-7 -translate-x-1/2 pointer-events-none z-20 rounded-md bg-black/90 px-2 py-0.5 text-[11px] font-bold text-white shadow-lg backdrop-blur-xs ring-1 ring-white/10"
        >
